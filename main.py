...
class ParaCrawl:
    def __init__(self, skip_already_exist=True, n_threads=4, do_google=True, download_path='download', full_resolution=False, face=False, limit=0):
    ...
    def imbalance_check(self):
        ...
        if len(dict_too_small) >= 1:
            ...
            print('Below keywords have smaller than 50 percent of average file count.')
...
if __name__ == '__main__':
    ...
    print('Options - skip:{}, threads:{}, google:{}, full_resolution:{}, face:{}, limit:{}'.format(_skip, _threads, _google, _full, _face, _limit))
    crawler = ParaCrawl(skip_already_exist=_skip, n_threads=_threads, do_google=_google, full_resolution=_full, face=_face, limit=_limit)
    crawler.do_crawling()
